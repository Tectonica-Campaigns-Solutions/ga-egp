  ...
  return (
    <div data-datocms-noindex>
      <Layout location={location} navbarWhite={page.textWhite ?? false} navbarYellowHover={page.textWhite ?? false}>
        <SeoDatoCms seo={page.seo} favicon={favicon} siteTitle={siteTitle} DsBgImage={page.backgroundImage.gatsbyImageData} MbBgImage={page.imageMobile.gatsbyImageData} homepage={true}/>
